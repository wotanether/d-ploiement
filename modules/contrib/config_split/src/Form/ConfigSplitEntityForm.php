...
class ConfigSplitEntityForm extends EntityForm {
  ...
  public function form(array $form, FormStateInterface $form_state) {
    ...
    $form['static_fieldset']['status'] = [
      '#title' => $this->t('Active'),
      '#markup' => $this->t('IMPORTANT - To activate split you have to do it in the settings.php file. For example: "$config[\'config_split.config_split.ENVIRONMENT_NAME\'][\'status\'] = TRUE;".'),
    ];
